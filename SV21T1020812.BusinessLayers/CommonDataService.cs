...
using SV21T1020812.DataLayers;
using SV21T1020812.DomainModels;

namespace SV21T1020812.BusinessLayers
{
    public static class CommonDataService
    {
        ...
        {
            string connectionString = "server=DESKTOP-EJ19S9P\\SQLEXPRESS;user id=sa;password=301219;database=LiteCommerceDB;TrustServerCertificate=true";
